...
file = "/home/hugo/ISEN/Cours/FireArmor/FireArmor-AI-Anomaly-Detection/FireArmor IA/DataSet/ADFA-LD/Training_Data_Master/UTD-0001.txt"
...
def sequence_n_gram_parsing(alist,n_gram=20,num_class=341):
    if (len(list(alist))<n_gram):
        return alist

    ans = []
    for i in range(0,len(list(alist))-n_gram+1,1):
...
if __name__ == "__main__":
    dirc = "/home/hugo/ISEN/Cours/FireArmor/FireArmor-AI-Anomaly-Detection/FireArmor IA/DataSet/ADFA-LD/Training_Data_Master/"
    dirc_val = "/home/hugo/ISEN/Cours/FireArmor/FireArmor-AI-Anomaly-Detection/FireArmor IA/DataSet/ADFA-LD/Validation_Data_Master/"
    dic_attack ="/home/hugo/ISEN/Cours/FireArmor/FireArmor-AI-Anomaly-Detection/FireArmor IA/DataSet/ADFA-LD/Attack_Data_Master/"
